...
function getDateInThePast(numDays) {
  ...
  return Utilities.formatDate(today, 'CST', 'MMddyyyy');
    ...
    if (RECIPIENT_EMAIL_1)  {
      MailApp.sendEmail(RECIPIENT_EMAIL_1, 'New Campaign Performance Report for EA Last 7 Days is ready.', spreadsheet.getUrl());
     }
    
    if (RECIPIENT_EMAIL_2)  {
      MailApp.sendEmail(RECIPIENT_EMAIL_2, 'New Campaign Performance Report for EA Last 7 Days is ready.', spreadsheet.getUrl());
     }
